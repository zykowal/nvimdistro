return {
  ...
  config = function(_, opts)
    ...
    vim.api.nvim_set_keymap("n", "<leader>tH", "<cmd>lua open_new_h_terminal()<CR>", { noremap = true, silent = true })
    ...
    vim.api.nvim_set_keymap("n", "<leader>tV", "<cmd>lua open_new_v_terminal()<CR>", { noremap = true, silent = true })
  end,
}
